 ...
 * Type integer range.
 *
 * Warning: Typescript use recursion for this. Max iteration from typescript is 1000,
 * ranges must be less than 1000, if higher return type will be any
 */
type Enumerate<
  N extends number,
  Acc extends number[] = []
...
type Percentage = IntRange<0, 100>;
```
